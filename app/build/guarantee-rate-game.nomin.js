...
/***/ function(module, exports, __webpack_require__) {
	...
	var _persist = __webpack_require__(204);
	
	var _persist2 = _interopRequireDefault(_persist);
	
	var _addKonamiCheat = __webpack_require__(208);
	...
	(0, _addKonamiCheat2.default)(store);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxUndo = __webpack_require__(120);
	
	var _decko = __webpack_require__(125);
	
	var _icons = __webpack_require__(126);
	...
	var _scores = __webpack_require__(145);
	
	var _scores2 = _interopRequireDefault(_scores);
	
	var _resetButton = __webpack_require__(156);
	...
	var _congrats = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(49)(IteratorPrototype, __webpack_require__(93)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _debug = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hammerjs = __webpack_require__(128);
	
	var _hammerjs2 = _interopRequireDefault(_hammerjs);
	
	var _moJs = __webpack_require__(129);
	...
	var Card = function (_Component) {
	  ...
	  (0, _createClass3.default)(Card, [{
	    ...
	    value: function render() {
	      var p = this.props;
	      var type = p.type;
	      var className = CLASSES['card' + postfix] + ' ' + CLASSES['card' + postfix + '--' + type];
	
	      if (p.isOpen) {
	        className += ' ' + CLASSES['is-open' + postfix];
	      }
	      return (0, _preact.h)(
	        'div',
	        ...
	        (0, _preact.h)(
	          'div',
	          { className: CLASSES['card' + postfix + '__inner'] },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._icon_1kwuf_5{position:relative;width:32px;height:32px;cursor:pointer;fill:#fff;display:block}._icon_1kwuf_5>svg{position:absolute;left:0;top:0;width:100%;height:100%;fill:inherit}._icon_1kwuf_5>svg>use{fill:inherit}._icon_1kwuf_5:after{content:'';position:absolute;left:0;top:0;right:0;bottom:0;z-index:1}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _howler = __webpack_require__(138);
	...
	var CardStagger = function (_Component) {
	  ...
	  function CardStagger() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (CardStagger.__proto__ || (0, _getPrototypeOf2.default)(CardStagger)).apply(this, arguments));
	  }
	...
	*/
	exports.default = function () {
	  ...
	  if (navigator.appName == 'Microsoft Internet Explorer') {
	    ...
	    if (_re.exec(ua) != null) rv = parseFloat(RegExp.$1);
	  }
	  return rv > -1;
	};
...
/***/ function(module, exports) {
	...
	module.exports = {
		"card": "_card_7rmut_4",
		"is-open": "_is-open_7rmut_25",
		"card__inner": "_card__inner_7rmut_1",
		"card-ie": "_card-ie_7rmut_61",
		"is-open-ie": "_is-open-ie_7rmut_79",
		"card-ie__inner": "_card-ie__inner_7rmut_81"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._card_7rmut_4{position:relative;width:65px;height:90px;background:#fff;display:block;border-radius:7px;margin-left:20px;margin-top:20px;cursor:pointer;background:#f27b35;background-image:url(data:image/png;base64,);background-size:100% auto;-webkit-transform:rotateY(180deg);transform:rotateY(180deg);-webkit-transition:all .2s ease-out;transition:all .2s ease-out;-webkit-transform-style:preserve-3d;transform-style:preserve-3d;box-shadow:0 0 16px rgba(0,0,0,.8);box-shadow:0 0 0 3px rgba(0,0,0,.1),inset 2px 0 10px hsla(0,0%,100%,.35)}._card_7rmut_4 [data-component=icon]{fill:#2c405a;position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);width:44px;height:44px;-webkit-backface-visibility:hidden;backface-visibility:hidden}._card_7rmut_4:hover{-webkit-transform:rotateY(170deg);transform:rotateY(170deg)}._card_7rmut_4._is-open_7rmut_25{-webkit-transform:rotateY(0deg);transform:rotateY(0deg)}._card__inner_7rmut_1{position:absolute;width:100%;height:100%;background:#fff;box-sizing:border-box;border-radius:inherit;-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-transform-style:preserve-3d;transform-style:preserve-3d;-webkit-transform:translateZ(1px);transform:translateZ(1px)}@media all and (max-width:535px){._card_7rmut_4{margin-left:10px;margin-top:10px}}@media all and (max-width:450px){._card_7rmut_4{margin-left:15px;margin-top:15px}}._card-ie_7rmut_61{position:relative;width:65px;height:90px;background:#fff;display:block;border-radius:7px;margin-left:20px;margin-top:20px;cursor:pointer;background:#f27b35;background-image:url(data:image/png;base64,);background-size:100% auto;-webkit-transition:all .2s ease-out;transition:all .2s ease-out;-webkit-transform-style:preserve-3d;transform-style:preserve-3d;box-shadow:0 0 16px rgba(0,0,0,.8);box-shadow:0 0 0 3px rgba(0,0,0,.1),inset 2px 0 10px hsla(0,0%,100%,.35)}._card-ie_7rmut_61 [data-component=icon]{fill:#2c405a;position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);width:44px;height:44px;-webkit-backface-visibility:hidden;backface-visibility:hidden}._card-ie_7rmut_61:hover:not(._is-open-ie_7rmut_79){-webkit-transform:scaleX(.9);transform:scaleX(.9)}._card-ie_7rmut_61._is-open-ie_7rmut_79 ._card-ie__inner_7rmut_81{-webkit-transform:scaleX(1);transform:scaleX(1)}._card-ie__inner_7rmut_81{position:absolute;width:100%;height:100%;background:#fff;box-sizing:border-box;border-radius:inherit;-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-transform-style:preserve-3d;transform-style:preserve-3d;-webkit-transform:scaleX(0);transform:scaleX(0)}@media all and (max-width:535px){._card-ie_7rmut_61{margin-left:10px;margin-top:10px}}@media all and (max-width:450px){._card-ie_7rmut_61{margin-left:15px;margin-top:15px}}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tryStagger = __webpack_require__(146);
	
	var _tryStagger2 = _interopRequireDefault(_tryStagger);
	
	var _ghost = __webpack_require__(149);
	...
	var Scores = function (_Component) {
	  ...
	  function Scores() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (Scores.__proto__ || (0, _getPrototypeOf2.default)(Scores)).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mojsAddThunder = __webpack_require__(148);
	...
	var TryStagger = function (_Component) {
	  ...
	  function TryStagger() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (TryStagger.__proto__ || (0, _getPrototypeOf2.default)(TryStagger)).apply(this, arguments));
	  }
	  ...
	  (0, _createClass3.default)(TryStagger, [{
	    ...
	    value: function shouldComponentUpdate() {
	      ...
	      var _store$getState = store.getState(),
	          cards = _store$getState.cards;
	
	      if (cards.present.tries === 0) {
	        this._tries = 0;
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Thunder = function (_mojs$CustomShape) {
	  ...
	  function Thunder() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (Thunder.__proto__ || (0, _getPrototypeOf2.default)(Thunder)).apply(this, arguments));
	  }
...
/***/ function(module, exports) {
	...
	module.exports = {
		"ghost": "_ghost_1e0v7_7",
		"ghost__left": "_ghost__left_1e0v7_29",
		"ghost__right": "_ghost__right_1e0v7_30",
		"ghost__inner": "_ghost__inner_1e0v7_1",
		"floating": "_floating_1e0v7_1",
		"ghost__shadow": "_ghost__shadow_1e0v7_1",
		"floatingShadow": "_floatingShadow_1e0v7_1"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._ghost_1e0v7_7{position:relative;width:64px;height:60px}._ghost_1e0v7_7 [data-component=icon]{position:absolute;width:100%;height:100%;fill:#fff;cursor:default}._ghost_1e0v7_7 [data-component=icon]._ghost__left_1e0v7_29,._ghost_1e0v7_7 [data-component=icon]._ghost__right_1e0v7_30{opacity:.75}._ghost_1e0v7_7 [data-component=icon]._ghost__left_1e0v7_29{fill:cyan;display:none;-webkit-transform:translateX(-1px);transform:translateX(-1px)}._ghost_1e0v7_7 [data-component=icon]._ghost__right_1e0v7_30{fill:hotpink;display:none;-webkit-transform:translateX(1px);transform:translateX(1px)}._ghost__inner_1e0v7_1{position:relative;z-index:1;width:64px;height:60px;-webkit-animation:_floating_1e0v7_1 3s ease-in-out infinite;animation:_floating_1e0v7_1 3s ease-in-out infinite}._ghost__shadow_1e0v7_1{position:absolute;width:60%;left:20%;height:7px;bottom:-10px;background:rgba(0,0,0,.15);border-radius:50%;-webkit-animation:_floatingShadow_1e0v7_1 3s ease-in-out infinite;animation:_floatingShadow_1e0v7_1 3s ease-in-out infinite}@-webkit-keyframes _floating_1e0v7_1{0%{-webkit-transform:translateZ(0);transform:translateZ(0)}45%{-webkit-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}55%{-webkit-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}@keyframes _floating_1e0v7_1{0%{-webkit-transform:translateZ(0);transform:translateZ(0)}45%{-webkit-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}55%{-webkit-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}@-webkit-keyframes _floatingShadow_1e0v7_1{0%{-webkit-transform:scale(1);transform:scale(1)}45%{-webkit-transform:scale(.85);transform:scale(.85)}55%{-webkit-transform:scale(.85);transform:scale(.85)}to{-webkit-transform:scale(1);transform:scale(1)}}@keyframes _floatingShadow_1e0v7_1{0%{-webkit-transform:scale(1);transform:scale(1)}45%{-webkit-transform:scale(.85);transform:scale(.85)}55%{-webkit-transform:scale(.85);transform:scale(.85)}to{-webkit-transform:scale(1);transform:scale(1)}}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._scores_1i0fh_4 [data-component=ghost]{margin:0 auto 15px}._scores__text_1i0fh_1{position:relative;display:inline-block;font-size:20px;letter-spacing:.5px;margin-bottom:25px;color:#fff}._scores__text_1i0fh_1 em{font-size:24px;font-style:normal;color:#ec5351;font-weight:700}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _konamiBurst = __webpack_require__(161);
	
	var _konamiBurst2 = _interopRequireDefault(_konamiBurst);
	...
	var ResetButton = function (_Component) {
	  ...
	  function ResetButton() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (ResetButton.__proto__ || (0, _getPrototypeOf2.default)(ResetButton)).apply(this, arguments));
	  }
	  ...
	  (0, _createClass3.default)(ResetButton, [{
	    ...
	    */
	    ...
	    value: function _renderReset(state) {
	      ...
	      return (0, _preact.h)(
	        'span',
	        { className: CLS['reset-button__reset'] },
	        (0, _preact.h)(
	          'button',
	    ...
	    */
	    ...
	    value: function _renderMomento(state) {
	      ...
	      return (0, _preact.h)(
	        ...
	        (0, _preact.h)(_konamiBurst2.default, { state: state })
	      );
	    }
	  }, {
	    key: 'componentDidMount',
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._button_zxabv_4{background:#ec5351;font-size:14px;color:#fff;padding:6px 35px 8px;border-radius:4px;cursor:pointer;z-index:1;position:relative;display:inline-block}._button_zxabv_4:hover{background:#ff6361}._button_zxabv_4:active{background:#ec5351}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KonamiBurst = function (_Component) {
	  (0, _inherits3.default)(KonamiBurst, _Component);
	
	  function KonamiBurst() {
	    (0, _classCallCheck3.default)(this, KonamiBurst);
	    return (0, _possibleConstructorReturn3.default)(this, (KonamiBurst.__proto__ || (0, _getPrototypeOf2.default)(KonamiBurst)).apply(this, arguments));
	  }
	
	  (0, _createClass3.default)(KonamiBurst, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	
	      return (0, _preact.h)('span', { ref: function ref(el) {
	          _this2._el = el;
	        } });
	    }
	  }, {
	    ...
	    value: function componentDidMount() {
	      ...
	      this._burst = new _moJs2.default.Burst({
	        parent: this._el,
	        radius: { 4: 49 },
	        angle: 45,
	        count: 12,
	        ...
	        timeline: {
	          ...
	          onComplete: function onComplete() {
	            _this3.context.store.dispatch({ type: 'RESET_CHEAT_PLAY' });
	          }
	        }
	      });
...
/***/ function(module, exports) {
	...
	module.exports = {
		"reset-button": "_reset-button_xjr76_4",
		"reset-button__reset": "_reset-button__reset_xjr76_1",
		"reset-button__momento": "_reset-button__momento_xjr76_1",
		"is-disable": "_is-disable_xjr76_40",
		"is-cheat": "_is-cheat_xjr76_45",
		"reset-button__main": "_reset-button__main_xjr76_1",
		"reset-button__confirm": "_reset-button__confirm_xjr76_86",
		"is-confirm": "_is-confirm_xjr76_85"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._reset-button_xjr76_4{position:relative;display:inline-block;color:#fff}._reset-button_xjr76_4 button{border:none;cursor:pointer}._reset-button_xjr76_4 button:focus{outline:0}._reset-button__reset_xjr76_1{position:relative;display:inline-block;float:left;height:30px}._reset-button__momento_xjr76_1{background:#f27b35;height:31px;position:relative;margin-left:5px;border-radius:4px;display:none}._reset-button__momento_xjr76_1 [data-component=icon]{width:14px;height:14px;cursor:inherit}._reset-button__momento_xjr76_1:hover{opacity:.85}._reset-button__momento_xjr76_1:active{opacity:1}._reset-button__momento_xjr76_1._is-disable_xjr76_40{cursor:default;background:gray;opacity:.5}._reset-button__momento_xjr76_1._is-cheat_xjr76_45{display:inline-block}._reset-button__main_xjr76_1{background:#ec5351;font-size:14px;color:#fff;padding:6px 35px 8px;border-radius:4px;position:relative;cursor:pointer;z-index:1}._reset-button__main_xjr76_1:hover{background:#ff6361}._reset-button__main_xjr76_1:active{background:#ec5351}._reset-button__confirm_xjr76_86{background:#ffd555;color:#2c405a;position:absolute;top:100%;left:50%;height:20px;padding:2px 16px 7px;font-size:10px;border-bottom-left-radius:18px;border-bottom-right-radius:18px;-webkit-transform:translate(-50%,-100%);transform:translate(-50%,-100%);-webkit-transition:all .225s ease-out;transition:all .225s ease-out}._reset-button__confirm_xjr76_86:hover{opacity:.9}._reset-button_xjr76_4._is-confirm_xjr76_85 ._reset-button__confirm_xjr76_86{-webkit-transform:translate(-50%);transform:translate(-50%)}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CLS = __webpack_require__(169);
	...
	var Congrats = function (_Component) {
	  ...
	  function Congrats() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (Congrats.__proto__ || (0, _getPrototypeOf2.default)(Congrats)).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CongratsCounter = function (_Component) {
	  ...
	  function CongratsCounter() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (CongratsCounter.__proto__ || (0, _getPrototypeOf2.default)(CongratsCounter)).apply(this, arguments));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._congrats_1234o_3{position:absolute;z-index:5;left:0;top:20px;right:0;bottom:0;display:none;overflow:hidden}._congrats__counter_1234o_1{position:absolute;top:15px;right:20px;z-index:2;color:#2c405a;opacity:0}._congrats__counter-footer_1234o_1{font-family:bebasregular;font-size:7px;width:30px;text-align:center}._congrats__counter-number_1234o_1{font-family:Menlo,sans-serif;color:$c-green;font-size:14px;text-align:center}._congrats__background_1234o_1{position:absolute;left:0;top:0;right:0;bottom:0;opacity:.975;overflow:hidden;border-radius:6px}._congrats__button_1234o_1{position:absolute;left:50%;top:50%;cursor:pointer;margin-top:20px;margin-left:-50px;border:none;color:#fff;font:inherit;padding:10px 20px;z-index:1;-webkit-appearance:none;-moz-appearance:none;appearance:none;border-radius:6px;background:transparent;overflow:hidden;outline:0;letter-spacing:.5px;font-size:12px}._congrats__button_1234o_1:hover{opacity:.85}._congrats__button-text_1234o_1{position:relative;z-index:2;display:inline-block;opacity:0}._congrats__texts_1234o_1{position:absolute;z-index:2;width:270px;left:50%;margin-left:-135px;top:20%}._congrats__text_1234o_1{position:absolute;top:0;font-family:Bebas,bebasregular;font-size:20px;text-transform:uppercase;letter-spacing:.5px;opacity:0}._congrats__text--1_1234o_1{left:0;color:#ec5351;-webkit-transform:rotate(-10deg) translateY(7px);transform:rotate(-10deg) translateY(7px)}._congrats__text--2_1234o_1{left:50%;margin-left:-15.5px;color:#2c405a}._congrats__text--3_1234o_1{right:0;color:#f27b35;-webkit-transform:rotate(10deg) translateY(7px);transform:rotate(10deg) translateY(7px)}", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"congrats": "_congrats_1234o_3",
		"congrats__counter": "_congrats__counter_1234o_1",
		"congrats__counter-footer": "_congrats__counter-footer_1234o_1",
		"congrats__counter-number": "_congrats__counter-number_1234o_1",
		"congrats__background": "_congrats__background_1234o_1",
		"congrats__button": "_congrats__button_1234o_1",
		"congrats__button-text": "_congrats__button-text_1234o_1",
		"congrats__texts": "_congrats__texts_1234o_1",
		"congrats__text": "_congrats__text_1234o_1",
		"congrats__text--1": "_congrats__text--1_1234o_1",
		"congrats__text--2": "_congrats__text--2_1234o_1",
		"congrats__text--3": "_congrats__text--3_1234o_1"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CongratsButton = (_class = function (_Component) {
	  ...
	  function CongratsButton() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (CongratsButton.__proto__ || (0, _getPrototypeOf2.default)(CongratsButton)).apply(this, arguments));
	  }
...
/***/ function(module, exports) {
	...
	module.exports = {
		"game": "_game_jpdz0_5",
		"fadeIn": "_fadeIn_jpdz0_1",
		"game__inner": "_game__inner_jpdz0_63",
		"game__left": "_game__left_jpdz0_58",
		"game__right": "_game__right_jpdz0_50"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._game_jpdz0_5{font-family:Arial,sans-serif;text-align:center;-webkit-perspective:800px;perspective:800px;padding-bottom:30px;position:absolute;left:50%;top:50%;margin-top:-235px;margin-left:-375px;-webkit-animation:_fadeIn_jpdz0_1 .5s ease-in;animation:_fadeIn_jpdz0_1 .5s ease-in}._game__inner_jpdz0_63{display:inline-block;padding-right:200px;position:relative}._game__left_jpdz0_58{width:550px;margin-left:-20px}._game__left_jpdz0_58 [data-component=card]{float:left}._game__right_jpdz0_50{position:absolute;right:0;top:0;bottom:0;width:200px;padding-top:140px}@media (max-width:820px){._game_jpdz0_5{width:100%;-webkit-transform:translateY(-50%);transform:translateY(-50%);margin-top:0;margin-left:0;left:0}._game_jpdz0_5 ._game__right_jpdz0_50{position:static;float:left;width:100%;padding-top:20px;padding-bottom:20px}._game_jpdz0_5 ._game__left_jpdz0_58{clear:both;padding-left:30px}._game_jpdz0_5 ._game__inner_jpdz0_63{padding-right:0}}@media (max-width:535px){._game_jpdz0_5{left:0;margin:0 auto}._game_jpdz0_5 ._game__left_jpdz0_58{width:450px;margin-left:-10px;padding-left:0}}@media (max-width:450px){._game_jpdz0_5 ._game__left_jpdz0_58{width:320px}}@media (max-height:460px){._game_jpdz0_5{top:0;margin-top:0;-webkit-transform:none;transform:none}}@media (max-width:820px) and (max-height:740px){._game_jpdz0_5{position:static;-webkit-transform:none;transform:none}}@-webkit-keyframes _fadeIn_jpdz0_1{0%{opacity:0}to{opacity:1}}@keyframes _fadeIn_jpdz0_1{0%{opacity:0}to{opacity:1}}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _indexReducer = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxRecycle = __webpack_require__(178);
	
	var _reduxRecycle2 = _interopRequireDefault(_reduxRecycle);
	
	var _cardsReducer = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slicedToArray2 = __webpack_require__(180);
	...
	var _makeCards = __webpack_require__(197);
	
	var _makeCards2 = _interopRequireDefault(_makeCards);
	
	var _checkEqual = __webpack_require__(201);
	...
	var cardsReducer = function cardsReducer() {
	  ...
	  switch (action.type) {
	    case 'OPEN_CARD':
	      {
	        ...
	        return (0, _checkEqual2.default)(newState, action);
	      }
	    ...
	    case 'RESET_CARDS':
	      {
	        var _cards2 = (0, _makeCards2.default)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isIterable2 = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _arrayShuffle = __webpack_require__(198);
	
	var _arrayShuffle2 = _interopRequireDefault(_arrayShuffle);
	
	var _makeCard = __webpack_require__(199);
	
	var _makeCard2 = _interopRequireDefault(_makeCard);
	
	var _clamp = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var controls = function controls() {
	  ...
	  switch (action.type) {
	    ...
	    case 'SET_CHEAT':
	      {
	        return (0, _extends3.default)({}, state, { isCheat: true, isCheatPlay: true });
	      }
	    case 'RESET_CHEAT_PLAY':
	      {
	        return (0, _extends3.default)({}, state, { isCheatPlay: false });
	      }
	  }
	  return state;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _addUnload = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _konamiKomando = __webpack_require__(209);
