...
/***/ function(module, exports, __webpack_require__) {
	...
	var _persist = __webpack_require__(195);
	
	var _persist2 = _interopRequireDefault(_persist);
	
	var _addKonamiCheat = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scores = __webpack_require__(137);
	
	var _scores2 = _interopRequireDefault(_scores);
	
	var _resetButton = __webpack_require__(148);
	...
	var _congrats = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checkOpenCards = __webpack_require__(132);
	
	var _checkOpenCards2 = _interopRequireDefault(_checkOpenCards);
	
	var _cardLockAnimation = __webpack_require__(133);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._card_1xj68_4{position:relative;width:65px;height:90px;background:#fff;display:block;border-radius:7px;margin-left:20px;margin-top:20px;cursor:pointer;background:#f27b35;background-image:url(data:image/png;base64,);background-size:100% auto;-webkit-transform:rotateY(180deg);transform:rotateY(180deg);-webkit-transition:all .2s ease-out;transition:all .2s ease-out;-webkit-transform-style:preserve-3d;transform-style:preserve-3d;box-shadow:0 0 16px rgba(0,0,0,.8);box-shadow:0 0 0 3px rgba(0,0,0,.1),inset 2px 0 10px hsla(0,0%,100%,.35)}._card_1xj68_4 [data-component=icon]{fill:#2c405a;position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);width:44px;height:44px;-webkit-backface-visibility:hidden;backface-visibility:hidden}._card_1xj68_4:hover{-webkit-transform:rotateY(170deg);transform:rotateY(170deg)}._card_1xj68_4._is-open_1xj68_25{-webkit-transform:rotateY(0deg);transform:rotateY(0deg)}._card__inner_1xj68_1{position:absolute;width:100%;height:100%;background:#fff;box-sizing:border-box;border-radius:inherit;-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-transform-style:preserve-3d;transform-style:preserve-3d}@media all and (max-width:535px){._card_1xj68_4{margin-left:10px;margin-top:10px}}@media all and (max-width:450px){._card_1xj68_4{margin-left:15px;margin-top:15px}}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tryStagger = __webpack_require__(138);
	
	var _tryStagger2 = _interopRequireDefault(_tryStagger);
	
	var _ghost = __webpack_require__(141);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mojsAddThunder = __webpack_require__(140);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._ghost_1puxy_7{position:relative;width:64px;height:60px}._ghost_1puxy_7 [data-component=icon]{position:absolute;width:100%;height:100%;fill:#fff;cursor:default}._ghost_1puxy_7 [data-component=icon]._ghost__left_1puxy_29,._ghost_1puxy_7 [data-component=icon]._ghost__right_1puxy_30{opacity:.75}._ghost_1puxy_7 [data-component=icon]._ghost__left_1puxy_29{fill:cyan;display:none;-webkit-transform:translateX(-1px);transform:translateX(-1px)}._ghost_1puxy_7 [data-component=icon]._ghost__right_1puxy_30{fill:hotpink;display:none;-webkit-transform:translateX(1px);transform:translateX(1px)}._ghost__inner_1puxy_1{position:relative;z-index:1;width:64px;height:60px;-webkit-animation:_floating_1puxy_1 3s ease-in-out infinite;animation:_floating_1puxy_1 3s ease-in-out infinite}._ghost__shadow_1puxy_1{position:absolute;width:60%;left:20%;height:7px;bottom:-10px;background:rgba(0,0,0,.15);border-radius:50%;-webkit-animation:_floatingShadow_1puxy_1 3s ease-in-out infinite;animation:_floatingShadow_1puxy_1 3s ease-in-out infinite}@-webkit-keyframes _floating_1puxy_1{0%{-webkit-transform:translateZ(0);transform:translateZ(0)}45%{-webkit-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}55%{-webkit-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}@keyframes _floating_1puxy_1{0%{-webkit-transform:translateZ(0);transform:translateZ(0)}45%{-webkit-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}55%{-webkit-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}to{-webkit-transform:translateZ(0);transform:translateZ(0)}}@-webkit-keyframes _floatingShadow_1puxy_1{0%{-webkit-transform:scale(1);transform:scale(1)}45%{-webkit-transform:scale(.85);transform:scale(.85)}55%{-webkit-transform:scale(.85);transform:scale(.85)}to{-webkit-transform:scale(1);transform:scale(1)}}@keyframes _floatingShadow_1puxy_1{0%{-webkit-transform:scale(1);transform:scale(1)}45%{-webkit-transform:scale(.85);transform:scale(.85)}55%{-webkit-transform:scale(.85);transform:scale(.85)}to{-webkit-transform:scale(1);transform:scale(1)}}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _konamiBurst = __webpack_require__(153);
	
	var _konamiBurst2 = _interopRequireDefault(_konamiBurst);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var CLS = __webpack_require__(154);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"reset-button": "_reset-button_bpyys_4",
		"reset-button__reset": "_reset-button__reset_bpyys_1",
		"reset-button__momento": "_reset-button__momento_bpyys_1",
		"is-disable": "_is-disable_bpyys_39",
		"is-cheat": "_is-cheat_bpyys_44",
		"reset-button__main": "_reset-button__main_bpyys_1",
		"reset-button__confirm": "_reset-button__confirm_bpyys_85",
		"is-confirm": "_is-confirm_bpyys_84"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._reset-button_bpyys_4{position:relative;display:inline-block}._reset-button_bpyys_4 button{border:none;color:#fff;cursor:pointer}._reset-button_bpyys_4 button:focus{outline:0}._reset-button__reset_bpyys_1{position:relative;display:inline-block;float:left}._reset-button__momento_bpyys_1{background:#f27b35;height:31px;position:relative;margin-left:5px;border-radius:4px;display:none}._reset-button__momento_bpyys_1 [data-component=icon]{width:14px;height:14px;cursor:inherit}._reset-button__momento_bpyys_1:hover{opacity:.85}._reset-button__momento_bpyys_1:active{opacity:1}._reset-button__momento_bpyys_1._is-disable_bpyys_39{cursor:default;background:gray;opacity:.5}._reset-button__momento_bpyys_1._is-cheat_bpyys_44{display:inline-block}._reset-button__main_bpyys_1{background:#ec5351;font-size:14px;color:#fff;padding:6px 35px 8px;border-radius:4px;position:relative;cursor:pointer;z-index:1}._reset-button__main_bpyys_1:hover{background:#ff6361}._reset-button__main_bpyys_1:active{background:#ec5351}._reset-button__confirm_bpyys_85{background:#ffd555;color:#2c405a!important;position:absolute;top:100%;left:50%;height:20px;padding:2px 16px 7px;font-size:10px;border-bottom-left-radius:18px;border-bottom-right-radius:18px;-webkit-transform:translate(-50%,-100%);transform:translate(-50%,-100%);-webkit-transition:all .225s ease-out;transition:all .225s ease-out}._reset-button__confirm_bpyys_85:hover{opacity:.9}._reset-button_bpyys_4._is-confirm_bpyys_84 ._reset-button__confirm_bpyys_85{-webkit-transform:translate(-50%);transform:translate(-50%)}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CLS = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._congrats_pcf8y_3{position:absolute;z-index:5;left:0;top:20px;right:0;bottom:0;display:none;overflow:hidden}._congrats__counter_pcf8y_1{position:absolute;top:15px;right:20px;z-index:2;color:#2c405a;opacity:0}._congrats__counter-footer_pcf8y_1{font-family:bebasregular;font-size:7px;width:30px;text-align:center}._congrats__counter-number_pcf8y_1{font-family:Menlo;color:$c-green;font-size:14px;text-align:center}._congrats__background_pcf8y_1{position:absolute;left:0;top:0;right:0;bottom:0;opacity:.975;overflow:hidden;border-radius:6px}._congrats__button_pcf8y_1{position:absolute;left:50%;top:50%;cursor:pointer;margin-top:20px;margin-left:-50px;border:none;color:#fff;font:inherit;padding:10px 20px;z-index:1;-webkit-appearance:none;-moz-appearance:none;appearance:none;border-radius:6px;background:transparent;overflow:hidden;outline:0;letter-spacing:.5px;font-size:12px}._congrats__button_pcf8y_1:hover{opacity:.85}._congrats__button-text_pcf8y_1{position:relative;z-index:2;display:inline-block;opacity:0}._congrats__texts_pcf8y_1{position:absolute;z-index:2;width:270px;left:50%;margin-left:-135px;top:20%}._congrats__text_pcf8y_1{position:absolute;top:0;font-family:Bebas,bebasregular;font-size:20px;text-transform:uppercase;letter-spacing:.5px;opacity:0}._congrats__text--1_pcf8y_1{left:0;color:#ec5351;-webkit-transform:rotate(-10deg) translateY(7px);transform:rotate(-10deg) translateY(7px)}._congrats__text--2_pcf8y_1{left:50%;margin-left:-15.5px;color:#2c405a}._congrats__text--3_pcf8y_1{right:0;color:#f27b35;-webkit-transform:rotate(10deg) translateY(7px);transform:rotate(10deg) translateY(7px)}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._game_1b2wq_5{font-family:Arial,sans-serif;text-align:center;-webkit-perspective:800px;perspective:800px;padding-bottom:30px;position:absolute;left:50%;top:50%;margin-top:-235px;margin-left:-375px;-webkit-animation:_fadeIn_1b2wq_1 .5s ease-in;animation:_fadeIn_1b2wq_1 .5s ease-in}._game__inner_1b2wq_70{display:inline-block;padding-right:200px;position:relative}._game__left_1b2wq_65{width:550px;display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-line-pack:center;align-content:center;margin-left:-20px}._game__right_1b2wq_57{position:absolute;right:0;top:0;bottom:0;width:200px;padding-top:140px}@media (max-width:820px){._game_1b2wq_5{width:100%;-webkit-transform:translateY(-50%);transform:translateY(-50%);margin-top:0;margin-left:0;left:0}._game_1b2wq_5 ._game__right_1b2wq_57{position:static;float:left;width:100%;padding-top:20px;padding-bottom:20px}._game_1b2wq_5 ._game__left_1b2wq_65{clear:both;padding-left:30px}._game_1b2wq_5 ._game__inner_1b2wq_70{padding-right:0}}@media (max-width:535px){._game_1b2wq_5{left:0;margin:0 auto}._game_1b2wq_5 ._game__left_1b2wq_65{width:450px;margin-left:-10px;padding-left:0}}@media (max-width:450px){._game_1b2wq_5 ._game__left_1b2wq_65{width:320px}}@media (max-height:460px){._game_1b2wq_5{top:0;margin-top:0;-webkit-transform:none;transform:none}}@media (max-width:820px) and (max-height:740px){._game_1b2wq_5{position:static;-webkit-transform:none;transform:none}}@-webkit-keyframes _fadeIn_1b2wq_1{0%{opacity:0}to{opacity:1}}@keyframes _fadeIn_1b2wq_1{0%{opacity:0}to{opacity:1}}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _indexReducer = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxRecycle = __webpack_require__(170);
	
	var _reduxRecycle2 = _interopRequireDefault(_reduxRecycle);
	
	var _cardsReducer = __webpack_require__(171);
	
	var _cardsReducer2 = _interopRequireDefault(_cardsReducer);
	
	var _controlsReducer = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slicedToArray2 = __webpack_require__(182);
	
	var _slicedToArray3 = _interopRequireDefault(_slicedToArray2);
	
	var _makeCards = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isIterable2 = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _arrayShuffle = __webpack_require__(190);
	
	var _arrayShuffle2 = _interopRequireDefault(_arrayShuffle);
	
	var _makeCard = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _addUnload = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _konamiKomando = __webpack_require__(200);
